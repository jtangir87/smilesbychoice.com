...
/* Help: http://www.tectite.com/fmdoc/target_email.php frontdesk."@dentistgentle\.com$*/
$TARGET_EMAIL = array($office."@smilesbychoice\.com$");


/* Help: http://www.tectite.com/fmdoc/def_alert.php */
$DEF_ALERT = "office@smilesbychoice.com";
...
$ATTACK_DETECTION_REVERSE_CAPTCHA = array("security1"=>"dbndng","security2"=>"");
...
function LoadBuiltinLanguage()
{
	...
	// Parameters: none
	$aMessages[MSG_NO_RECIP] = 'This is a legitimate message ' .
	                           'not an error.';
